# José Aparecido Fernandes Junior

Desenvolvedor backend em evolução, focado na construção de sistemas reais utilizando .NET e Angular.
...
* Experiência prática com C#, .NET e APIs REST
* Interesse em arquitetura de software e regras de negócio
* Desenvolvimento de projetos voltados para cenários reais
